...
PCMS has been a component of a number of funded grants from the U.S. Department of Energy to provide code-coupling capabilities \cite{StellFoundry, HiFiStell,CEDA,SimmetrixSBIR2024,SimmetrixSBIR2023,OASIS,OASIS2}. Due to the nature of multidisciplinary collaborative work, relevant application publications making use of PCMS are in preparation (targeting submission by August 2026).
