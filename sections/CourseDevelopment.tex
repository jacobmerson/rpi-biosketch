...
\item[MANE-4240/MANE-6660 -- Finite Element Methods]
...
These workflows include a FEniCS based workflow that is used to help students quickly see the connection between the weak formulation and a tool that can solve PDEs on complex geometries. Students can use FEniCS to experiment with solving PDEs that they are exposed to in their classes that may not be implemented in commercial FEM solvers. Many of the graduate students have adopted FEniCS-based workflows for their research after taking the FEM class.
...
In the next iteration of the course, I am planning to make more of the assignments into group assignments. This format seemed to provide a more accelerated learning environment that pushed students to write code and documentation that others could read, rather than just for themselves. I also anticipate having assignments that cover the use of LLM-based coding agents to help students understand the pros and cons of utilizing these tools.

Students were also expected to complete a final project where they applied the methods learned in the class to their research. Students are encouraged to submit their final projects to the Journal of Open Source Software and I provide I have received positive feedback from multiple faculty colleagues that this had a positive impact on their research.
